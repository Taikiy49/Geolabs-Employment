        ...
        <header className="intro-header-row">
          <div>
            <h2 className="intro-title">
              Geolabs, Inc. – Employment Opportunities
            </h2>
          ...
          <div className="intro-main">
            ...
            <div className="intro-hero">
              <div className="intro-hero-text">
                ...
                <p>
                  Our staff engineers and engineering technicians support
                  infrastructure and development projects throughout Hawaiʻi and
                  beyond. If you are motivated, detail-oriented, and willing to
                  learn, we encourage you to apply.
                </p>
              ...
              <div className="intro-hero-cta">
                ...
                <p className="intro-hero-note">
                  You will be guided through a multi-step application form. You
                  can review each step before submitting.
                </p>
              </div>
            </div>
                ...
                <details className="job-panel" open>
                  ...
                  <div className="job-panel-body">
                    ...
                    <ul>
                      ...
                      <li>
                        In current pursuit of a Master of Science in Civil
                        Engineering with geotechnical focus desired and related
                        engineering experience helpful.
                      </li>
                      ...
                      <li>
                        Able to work overtime hours (including evenings and
                        weekends).
                      </li>
                ...
                <details className="job-panel">
                  ...
                  <div className="job-panel-body">
                    ...
                    <ul>
                      ...
                      <li>
                        Prepare and submit data and observations in the form of
                        digital reports to reflect results of daily field work.
                      </li>
                      <li>
                        Communicate with Project Engineers and others, as applicable,
                        regarding construction site, project requirements, and
                        testing; observations and inspection requirements and
                        results.
                      </li>
                      <li>
                    ...
                    <ul>
                      ...
                      <li>
                        Strong organizational skills, problem solving abilities and
                        keen mathematical and analytical aptitude.
                      </li>
                      <li>
                    ...
                    <ul>
                      <li>
                        Regularly required to stand, observe, walk and talk or hear,
                        use hands and arms to push and pull.
                      </li>
                      <li>
                        Lift and/or move at least 50 pounds and have peripheral
                        vision.
                      </li>
                    </ul>
                  </div>
          ...
          <aside className="intro-side">
            <section className="side-card">
              ...
              <p className="legal-text">
                ...
                religion, gender or gender identity, sexual orientation, national
                origin, age, disability, genetic information, marital status, amnesty
                or status as a covered veteran and lactation in accordance with
            ...
            <section className="side-card">
              ...
              <p className="legal-text">
                As an equal opportunity employer, Geolabs, Inc. is also an
                ADA-compliant employer and is committed to providing reasonable
                accommodations for qualified applicants and employees who are able to
                perform the essential functions of the position satisfactorily where
                such reasonable accommodations do not create an undue hardship and
                enable employees with disabilities to perform the essential functions
                of their jobs.
              </p>
            </section>
            ...
            <section className="side-card benefits-card">
              ...
              <ul className="benefits-list">
                ...
                <li>
                  <strong>Flexible Spending Account (FSA)</strong> – Allows employees
                  to save tax dollars on eligible, non-reimbursed health care
                  expenses, insurance premiums and/or dependent care out-of-pocket
                  expenses.
                </li>
              </ul>
            </section>
